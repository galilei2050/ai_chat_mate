...
<LegalPage>
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to My Awesome AI Chat.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to My Awesome AI Chat, accessible from <a href="https://chat.baskakov.us"
                                                                                         rel="external nofollow noopener"
                                                                                         target="_blank">https://chat.baskakov.us</a>
            </p>
        </li>
        <li>
    ...
    <p>By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the
        ...
        Service.</p>
    <h2>Contact Us</h2>
    <p>If you have any questions about these Terms and Conditions, You can contact us by visiting this page on our
        website
        <a
                href="/contact" rel="external nofollow noopener" target="_blank"> contact page</a>
    </p>
</LegalPage>