...
<LegalPage>
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
                refers to My Awesome AI Chat .</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to My Awesome AI Chat , accessible from <a
                    href="https://chat.baskakov.us" rel="external nofollow noopener" target="_blank">https://chat.baskakov.us</a>
            </p>
        </li>
        <li>
    ...
    <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile
        ...
        learn more about cookies on <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank">TermsFeed
            website</a> article.</p>
    ...
    <h2>Contact Us</h2>
    <p>If you have any questions about this Privacy Policy, You can contact us by visiting this page on our website <a
